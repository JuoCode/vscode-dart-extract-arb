...
var require_errors = __commonJS({
  "node_modules/deepl-node/dist/errors.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.DocumentNotReadyError = exports2.GlossaryNotFoundError = exports2.DocumentTranslationError = exports2.ConnectionError = exports2.TooManyRequestsError = exports2.QuotaExceededError = exports2.AuthorizationError = exports2.DeepLError = void 0;
    ...
    exports2.DeepLError = DeepLError;
    ...
    exports2.QuotaExceededError = QuotaExceededError;
    ...
    exports2.DocumentTranslationError = DocumentTranslationError;
    var GlossaryNotFoundError = class extends DeepLError {
    };
    exports2.GlossaryNotFoundError = GlossaryNotFoundError;
    var DocumentNotReadyError = class extends DeepLError {
    };
    exports2.DocumentNotReadyError = DocumentNotReadyError;
  }
});
...
var require_utils = __commonJS({
  "node_modules/deepl-node/dist/utils.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.validateAndAppendTextOptions = exports2.appendTextsAndReturnIsSingular = exports2.buildURLSearchParams = exports2.nonRegionalLanguageCode = exports2.standardizeLanguageCode = exports2.isFreeAccountAuthKey = exports2.toBoolString = exports2.isString = exports2.timeout = exports2.streamToString = exports2.streamToBuffer = exports2.logInfo = exports2.logDebug = void 0;
    ...
    exports2.toBoolString = toBoolString;
    function isFreeAccountAuthKey(authKey) {
      return authKey.endsWith(":fx");
    }
    exports2.isFreeAccountAuthKey = isFreeAccountAuthKey;
    ...
    exports2.standardizeLanguageCode = standardizeLanguageCode;
    ...
    exports2.nonRegionalLanguageCode = nonRegionalLanguageCode;
    ...
    function buildURLSearchParams(sourceLang, targetLang, formality, glossary, extraRequestParameters) {
      ...
      if (glossary !== void 0 && !isString(glossary)) {
    ...
    exports2.buildURLSearchParams = buildURLSearchParams;
    ...
    exports2.appendTextsAndReturnIsSingular = appendTextsAndReturnIsSingular;
    function validateAndAppendTextOptions(data, options2) {
      if (!options2) {
        return;
      }
      if (options2.splitSentences !== void 0) {
        options2.splitSentences = options2.splitSentences.toLowerCase();
        if (options2.splitSentences === "on" || options2.splitSentences === "default") {
          data.append("split_sentences", "1");
        } else if (options2.splitSentences === "off") {
          data.append("split_sentences", "0");
        } else {
          data.append("split_sentences", options2.splitSentences);
        }
      }
      if (options2.preserveFormatting !== void 0) {
        data.append("preserve_formatting", toBoolString(options2.preserveFormatting));
      }
      if (options2.tagHandling !== void 0) {
        data.append("tag_handling", options2.tagHandling);
      }
      if (options2.outlineDetection !== void 0) {
        data.append("outline_detection", toBoolString(options2.outlineDetection));
      }
      if (options2.context !== void 0) {
        data.append("context", options2.context);
      }
      if (options2.modelType !== void 0) {
        data.append("model_type", options2.modelType);
      }
      if (options2.nonSplittingTags !== void 0) {
        data.append("non_splitting_tags", joinTagList(options2.nonSplittingTags));
      }
      if (options2.splittingTags !== void 0) {
        data.append("splitting_tags", joinTagList(options2.splittingTags));
      }
      if (options2.ignoreTags !== void 0) {
        data.append("ignore_tags", joinTagList(options2.ignoreTags));
      }
    }
    exports2.validateAndAppendTextOptions = validateAndAppendTextOptions;
  }
});

// node_modules/deepl-node/dist/glossaryEntries.js
var require_glossaryEntries = __commonJS({
  "node_modules/deepl-node/dist/glossaryEntries.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    var GlossaryEntries = class _GlossaryEntries {
      ...
      constructor(options2) {
        this.implEntries = {};
        if ((options2 === null || options2 === void 0 ? void 0 : options2.entries) !== void 0) {
          if ((options2 === null || options2 === void 0 ? void 0 : options2.tsv) !== void 0) {
            throw new errors_1.DeepLError("options.entries and options.tsv are mutually exclusive");
          }
          Object.assign(this.implEntries, options2.entries);
        } else if ((options2 === null || options2 === void 0 ? void 0 : options2.tsv) !== void 0) {
          const tsv = options2.tsv;
    ...
    exports2.GlossaryEntries = GlossaryEntries;
  }
});

// node_modules/deepl-node/dist/types.js
var require_types = __commonJS({
  "node_modules/deepl-node/dist/types.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
  }
});
...
var require_client = __commonJS({
  "node_modules/deepl-node/dist/client.js"(exports2) {
    "use strict";
    ...
    var HttpClient = class _HttpClient {
      ...
      prepareRequest(method, url, timeoutMs, responseAsStream, options2) {
        const headers = Object.assign({}, this.headers, options2.headers);
        ...
        if (options2.fileBuffer) {
          const form = new form_data_1.default();
          form.append("file", options2.fileBuffer, { filename: options2.filename });
          if (options2.data) {
            for (const [key, value] of options2.data.entries()) {
          ...
          if (method === "GET") {
            axiosRequestConfig.params = options2.data;
          } else {
            axiosRequestConfig.data = options2.data;
          }
        }
       ...
       */
      async sendRequestWithBackoff(method, url, options2, responseAsStream = false) {
        options2 = options2 === void 0 ? {} : options2;
        (0, utils_1.logInfo)(`Request to DeepL API ${method} ${url}`);
        (0, utils_1.logDebug)(`Request details: ${options2.data}`);
        ...
        while (backoff.getNumRetries() <= this.maxRetries) {
          ...
          const axiosRequestConfig = this.prepareRequest(method, url, timeoutMs, responseAsStream, options2);
          try {
...
var require_parsing = __commonJS({
  "node_modules/deepl-node/dist/parsing.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.parseDocumentHandle = exports2.parseGlossaryLanguagePairArray = exports2.parseLanguageArray = exports2.parseWriteResultArray = exports2.parseTextResultArray = exports2.parseUsage = exports2.parseDocumentStatus = exports2.parseGlossaryInfoList = exports2.parseGlossaryInfo = void 0;
    var errors_1 = require_errors();
    var utils_1 = require_utils();
    ...
    function parseGlossaryInfo(json2) {
      try {
    ...
    exports2.parseGlossaryInfo = parseGlossaryInfo;
    function parseGlossaryInfoList(json2) {
      try {
        const obj = JSON.parse(json2);
    ...
    exports2.parseGlossaryInfoList = parseGlossaryInfoList;
    function parseDocumentStatus(json2) {
      try {
        const obj = JSON.parse(json2);
    ...
    exports2.parseDocumentStatus = parseDocumentStatus;
    ...
    exports2.parseUsage = parseUsage;
    function parseTextResultArray(json2) {
      try {
        const obj = JSON.parse(json2);
    ...
    exports2.parseTextResultArray = parseTextResultArray;
    function parseWriteResultArray(json2) {
      try {
        const obj = JSON.parse(json2);
    ...
    exports2.parseWriteResultArray = parseWriteResultArray;
    ...
    function parseLanguageArray(json2) {
      const obj = JSON.parse(json2);
      return obj.map((lang) => parseLanguage(lang));
    }
    exports2.parseLanguageArray = parseLanguageArray;
    ...
    function parseGlossaryLanguagePairArray(json2) {
      const obj = JSON.parse(json2);
      return obj.supported_languages.map((langPair) => parseGlossaryLanguagePair(langPair));
    }
    exports2.parseGlossaryLanguagePairArray = parseGlossaryLanguagePairArray;
    function parseDocumentHandle(json2) {
      try {
        const obj = JSON.parse(json2);
    ...
    exports2.parseDocumentHandle = parseDocumentHandle;
  }
});

// node_modules/deepl-node/dist/translator.js
var require_translator = __commonJS({
  "node_modules/deepl-node/dist/translator.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.Translator = exports2.checkStatusCode = void 0;
    ...
    exports2.checkStatusCode = checkStatusCode;
    var Translator2 = class {
      ...
      constructor(authKey, options2) {
        ...
        const headers = {
          ...
          "User-Agent": this.constructUserAgentString((options2 === null || options2 === void 0 ? void 0 : options2.sendPlatformInfo) === false ? false : true, options2 === null || options2 === void 0 ? void 0 : options2.appInfo),
          ...(_a = options2 === null || options2 === void 0 ? void 0 : options2.headers) !== null && _a !== void 0 ? _a : {}
        };
        const maxRetries = (options2 === null || options2 === void 0 ? void 0 : options2.maxRetries) !== void 0 ? options2.maxRetries : 5;
        const minTimeout = (options2 === null || options2 === void 0 ? void 0 : options2.minTimeout) !== void 0 ? options2.minTimeout : 5e3;
        this.httpClient = new client_1.HttpClient(serverUrl, headers, maxRetries, minTimeout, options2 === null || options2 === void 0 ? void 0 : options2.proxy);
      }
      /**
       ...
       */
      async translateText(texts, sourceLang, targetLang, options2) {
        const data = (0, utils_1.buildURLSearchParams)(sourceLang, targetLang, options2 === null || options2 === void 0 ? void 0 : options2.formality, options2 === null || options2 === void 0 ? void 0 : options2.glossary, options2 === null || options2 === void 0 ? void 0 : options2.extraRequestParameters);
        data.append("show_billed_characters", "1");
        const singular = (0, utils_1.appendTextsAndReturnIsSingular)(data, texts);
        (0, utils_1.validateAndAppendTextOptions)(data, options2);
       ...
       */
      async translateDocument(inputFile, outputFile, sourceLang, targetLang, options2) {
        async function getOutputHandleAndOnError() {
          if ((0, utils_1.isString)(outputFile)) {
            const outputHandle2 = await fs3.promises.open(outputFile, "wx");
            const onError2 = async () => {
              try {
                await outputHandle2.close();
                await util.promisify(fs3.unlink)(outputFile);
              } catch {
              }
            };
        ...
        try {
          documentHandle = await this.uploadDocument(inputFile, sourceLang, targetLang, options2);
       ...
       */
      async uploadDocument(inputFile, sourceLang, targetLang, options2) {
        if ((0, utils_1.isString)(inputFile)) {
          const buffer = await fs3.promises.readFile(inputFile);
          return this.internalUploadDocument(buffer, sourceLang, targetLang, path_1.default.basename(inputFile), options2);
        } else {
          if ((options2 === null || options2 === void 0 ? void 0 : options2.filename) === void 0) {
            throw new errors_1.DeepLError("options.filename must be specified unless using input file path");
          }
          if (inputFile instanceof fs3.ReadStream) {
            const buffer = await (0, utils_1.streamToBuffer)(inputFile);
            return this.internalUploadDocument(buffer, sourceLang, targetLang, options2.filename, options2);
          } else if (inputFile instanceof Buffer) {
            return this.internalUploadDocument(inputFile, sourceLang, targetLang, options2.filename, options2);
          } else {
            const buffer = await inputFile.readFile();
            const handle = await this.internalUploadDocument(buffer, sourceLang, targetLang, options2.filename, options2);
      ...
      async downloadDocument(handle, outputFile) {
        if ((0, utils_1.isString)(outputFile)) {
          const fileStream = await fs3.createWriteStream(outputFile, { flags: "wx" });
          try {
            await this.internalDownloadDocument(handle, fileStream);
          } catch (e) {
            await new Promise((resolve) => fileStream.close(resolve));
            await fs3.promises.unlink(outputFile);
            throw e;
          }
        } else if (outputFile instanceof fs3.WriteStream) {
          return this.internalDownloadDocument(handle, outputFile);
        } else {
          const dummyFilePath = "";
          const outputStream = fs3.createWriteStream(dummyFilePath, { fd: outputFile.fd });
      ...
      async createGlossaryWithCsv(name, sourceLang, targetLang, csvFile) {
        ...
        if ((0, utils_1.isString)(csvFile)) {
          csvContent = (await fs3.promises.readFile(csvFile)).toString();
        } else if (csvFile instanceof fs3.ReadStream) {
       ...
       * @private
       */
      async internalUploadDocument(fileBuffer, sourceLang, targetLang, filename, options2) {
        const data = (0, utils_1.buildURLSearchParams)(sourceLang, targetLang, options2 === null || options2 === void 0 ? void 0 : options2.formality, options2 === null || options2 === void 0 ? void 0 : options2.glossary, options2 === null || options2 === void 0 ? void 0 : options2.extraRequestParameters);
      ...
      constructUserAgentString(sendPlatformInfo, appInfo) {
        ...
        if (sendPlatformInfo) {
          const systemType = os2.type();
          const systemVersion = os2.version();
    ...
    exports2.Translator = Translator2;
  }
});

// node_modules/deepl-node/dist/deeplClient.js
var require_deeplClient = __commonJS({
  "node_modules/deepl-node/dist/deeplClient.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.DeepLClient = exports2.WritingTone = exports2.WritingStyle = void 0;
    var translator_1 = require_translator();
    var parsing_1 = require_parsing();
    var utils_1 = require_utils();
    var WritingStyle;
    (function(WritingStyle2) {
      WritingStyle2["ACADEMIC"] = "academic";
      WritingStyle2["BUSINESS"] = "business";
      WritingStyle2["CASUAL"] = "casual";
      WritingStyle2["DEFAULT"] = "default";
      WritingStyle2["PREFER_ACADEMIC"] = "prefer_academic";
      WritingStyle2["PREFER_BUSINESS"] = "prefer_business";
      WritingStyle2["PREFER_CASUAL"] = "prefer_casual";
      WritingStyle2["PREFER_SIMPLE"] = "prefer_simple";
      WritingStyle2["SIMPLE"] = "simple";
    })(WritingStyle = exports2.WritingStyle || (exports2.WritingStyle = {}));
    var WritingTone;
    (function(WritingTone2) {
      WritingTone2["CONFIDENT"] = "confident";
      WritingTone2["DEFAULT"] = "default";
      WritingTone2["DIPLOMATIC"] = "diplomatic";
      WritingTone2["ENTHUSIASTIC"] = "enthusiastic";
      WritingTone2["FRIENDLY"] = "friendly";
      WritingTone2["PREFER_CONFIDENT"] = "prefer_confident";
      WritingTone2["PREFER_DIPLOMATIC"] = "prefer_diplomatic";
      WritingTone2["PREFER_ENTHUSIASTIC"] = "prefer_enthusiastic";
      WritingTone2["PREFER_FRIENDLY"] = "prefer_friendly";
    })(WritingTone = exports2.WritingTone || (exports2.WritingTone = {}));
    var DeepLClient = class extends translator_1.Translator {
      constructor(authKey, options2 = {}) {
        super(authKey, options2);
      }
    ...
    exports2.DeepLClient = DeepLClient;
  }
});

// node_modules/deepl-node/dist/index.js
var require_dist = __commonJS({
  "node_modules/deepl-node/dist/index.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    __exportStar(require_glossaryEntries(), exports2);
    __exportStar(require_types(), exports2);
    __exportStar(require_deeplClient(), exports2);
...
var deepl = __toESM(require_dist());
...
async function extractToArb(document2, range, text) {
  ...
  const key = options.autoGenerateKeyName ? extractKeyNameFromText(
...
async function addImportIfMissing(document2, editor) {
  ...
  editor.insert(document2.uri, new vscode2.Position(0, 0), importStr + "\n");
}
...
function updateFile(filename, key, value) {
  try {
    let arbContent = fs2.existsSync(filename) ? fs2.readFileSync(filename, "utf8") : "{}";
    let arbJson = JSON.parse(arbContent);
    arbJson[key] = value;
    fs2.writeFileSync(filename, JSON.stringify(arbJson, null, 2), "utf8");
    return true;
  } catch (error) {
    vscode2.window.showErrorMessage(`Failed to update ARB file: ${error}`);
    return false;
  }
}
...
function activate(context) {
  const provider = vscode3.languages.registerCodeActionsProvider(
    { language: "dart", scheme: "file" },
    new ExtractToArbProvider(),
    { providedCodeActionKinds: [vscode3.CodeActionKind.Refactor] }
  );
  const command = vscode3.commands.registerCommand(
...
var ExtractToArbProvider = class {
  provideCodeActions(document2, range) {
    let text = document2.getText(range);
    if (!text) {
      const wordRange = document2.getWordRangeAtPosition(
        range.start,
        /(['"])(.*?)\1/
      );
      if (!wordRange) return [];
...
function createExtractToArbAction(document2, range, text) {
  const action = new vscode3.CodeAction(
    ...
    vscode3.CodeActionKind.RefactorExtract
  );
  action.command = {
    command: "flutter.extractToArb",
    title: "Extract String to ARB",
    arguments: [document2, range, text]
  };
  return action;
}
